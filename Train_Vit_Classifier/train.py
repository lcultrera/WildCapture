...
from dataloader.dataLoader import load_data  # Import your DataLoader function
from model.VitModel import VitModel  # Import your VitModel class
from loss_optimizer.loss_optimizer import create_loss_optimizer  # Import your loss and optimizer function
import yaml
import tqdm
...
if __name__ == "__main__":
    ...
    dataloaders, dataset_sizes, class_names = load_data(data_dir, batch_size, num_workers, img_size, weighted_sampling, split_dataset, train_split)
